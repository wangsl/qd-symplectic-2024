...
addpath(strcat(base_dir, '/OHCl/RKHS3Adp'));
addpath(strcat(base_dir, '/build/OHCl/RKHS3Adp'));

setenv('OHCL_RKHS_DATA_DIR', strcat(base_dir, '/OHCl/RKHS3Adp'));
...
time.total_steps = int32(90000000);
time.time_step = 1.0;
time.steps = int32(0);
...
OHClData.CRP = CRP;
OHClData.SI_coefficients = SI_coefficients;
