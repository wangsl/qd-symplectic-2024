...
function main() 
{
    ...
    export OPTIMIZATION_FLAGS_FOR_INTEL_COMPILERS="-fPIC -unroll -ip -axCORE-AVX512 -qopenmp -qopt-report-stdout -qopt-report-phase=openmp -fp-model strict"
    
    export OPTIMIZATION_FLAGS_FOR_INTEL_FORTRAN_COMPILERS="-fPIC -unroll -ip -axCORE-AVX512 -qopenmp -qopt-report-stdout -qopt-report-phase=openmp -fp-model strict"
