...
private:
  ...
  hipfftHandle cufft_plan_D2Z;
  hipfftHandle cufft_plan_Z2D;
  ...
  hipStream_t *computation_stream;
  hipStream_t *data_copy_stream;
  
  hipEvent_t *computation_event_for_left;
  hipEvent_t *computation_event_for_right;
  
  hipEvent_t *copy_to_left_event;
  hipEvent_t *copy_to_right_event;
